    ...
    <>
      ...
      >
        ...
        <div className="border-t border-border/50 px-3 py-4 space-y-1">
          ...
          {/* Logout via server action form — ensures cookie is cleared server-side */}
          <form action={logoutAction}>
            <button
              type="submit"
              className="nav-item w-full text-left hover:text-rose-400 hover:bg-rose-400/10"
            >
        ...
        <div className="px-4 pb-4">
          <div className="rounded-lg bg-primary/5 border border-primary/10 px-3 py-2.5">
            <p className="text-xs font-semibold text-foreground">Hassan</p>
            <p className="text-[10px] text-muted-foreground mt-0.5">B.Tech CSE · Sem 4 · 8.86 CGPA</p>
          </div>
        </div>
      </aside>
    </>
